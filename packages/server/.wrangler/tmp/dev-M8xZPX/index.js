...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/_internal/utils.mjs
// @__NO_SIDE_EFFECTS__
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/perf_hooks/performance.mjs
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/polyfill/performance.mjs
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/console.mjs
import { Writable } from "node:stream";

// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/mock/noop.mjs
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/node/console.mjs
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
globalThis.console = console_default;

// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/process/hrtime.mjs
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/process/process.mjs
import { EventEmitter } from "node:events";

// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/tty/read-stream.mjs
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/tty/write-stream.mjs
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/unenv/dist/runtime/node/internal/process/node-version.mjs
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/node_modules/@cloudflare/unenv-preset/dist/runtime/node/process.mjs
...
// ../../../.nvm/versions/node/v22.16.0/lib/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-process
...
var envSchema = external_exports.object({
  ...
  OPENAI_EMBEDDING_MODEL: external_exports.string().default("text-embedding-3-small"),
...
function createMemoryStore(env2) {
  ...
  return {
    ...
    async delete(params) {
      const query = `
        ...
        RETURNING namespace, id, title, content, metadata, created_at, updated_at, version;
      `;
      const rows = await sql(query, [params.namespace, params.memoId]);
      if (!rows.length) {
        return null;
      }
      return mapRow(rows[0]);
...
// src/openai.ts
async function generateEmbedding(env2, input) {
  const body = {
    input,
    model: env2.OPENAI_EMBEDDING_MODEL ?? "text-embedding-3-small"
  };
  const endpoint = env2.OPENAI_BASE_URL ?? "https://api.openai.com/v1/embeddings";
...
// src/schemas.ts
var primitiveValue = external_exports.union([external_exports.string(), external_exports.number(), external_exports.boolean(), external_exports.null()]);
var metadataValueSchema = external_exports.lazy(
  () => external_exports.union([primitiveValue, external_exports.array(metadataValueSchema), external_exports.record(metadataValueSchema)])
);
var metadataSchema = external_exports.record(metadataValueSchema);
var saveInputSchema = external_exports.object({
  namespace: external_exports.string().min(1),
  content: external_exports.string().min(1),
  metadata: metadataSchema.optional(),
  memoId: external_exports.string().min(1).optional(),
...
var searchInputSchema = external_exports.object({
  ...
  k: external_exports.coerce.number().int().min(1).max(100).default(10),
  minimumSimilarity: external_exports.coerce.number().min(0).max(1).optional()
});
var deleteInputSchema = external_exports.object({
  namespace: external_exports.string().min(1),
  memoId: external_exports.string().min(1)
});
var toolInvocationSchema = external_exports.object({
  tool: external_exports.enum(["memory.save", "memory.search", "memory.delete"]),
...
async function handleInvocation(invocation, envVars, dependencies = {}) {
  const store = dependencies.store ?? createMemoryStore(envVars);
  const embed = dependencies.embed ?? (async (input) => (await generateEmbedding(envVars, input)).vector);
  switch (invocation.tool) {
    case "memory.save": {
      const parsed = saveInputSchema.parse(invocation.params ?? {});
      const metadataPatch = parsed.metadata && Object.keys(parsed.metadata).length ? parsed.metadata : void 0;
    ...
    case "memory.search": {
      ...
      const embeddingVector = parsed.query ? await embed(parsed.query) : void 0;
      const metadataFilter = parsed.metadataFilter && Object.keys(parsed.metadataFilter).length ? parsed.metadataFilter : void 0;
    ...
    case "memory.delete": {
      ...
      const payload = { deleted: true, memo: deleted };
      return jsonResponse(payload, 200);
    }
    default:
...
var src_default = {
  async fetch(request, env2) {
    ...
    let envVars;
    try {
      envVars = parseEnv(env2);
    } catch (error3) {
      console.error("Environment validation failed", error3);
      return jsonResponse({ message: error3.message }, 500);
    }
    let body;
    try {
      body = await request.json();
    } catch (error3) {
      return jsonResponse({ message: "Invalid JSON body", detail: error3.message }, 400);
    }
    ...
    try {
      ...
      return jsonResponse({ message: "Internal server error", detail: error3.message }, 500);
    }
  }
};
...
// .wrangler/tmp/bundle-kq0GEw/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-kq0GEw/middleware-loader.entry.ts
